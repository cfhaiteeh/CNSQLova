...
def train(train_loader, train_table, model, model_bert, opt, bert_config, tokenizer,
    ...
    for iB, t in enumerate(train_loader):
        ...
        # Calculate loss & step
        loss = Loss_sw_se(s_sc, s_sa, s_wn, s_wc, s_wo, s_wv, g_sc, g_sa, g_wn, g_wc, g_wo, g_wvi,typ=True,g_wc=g_wc)
...
def print_result(acc, dname):
    ...
    print(
        f"  ave loss: {ave_loss}, acc_sn: {acc_sn:.3f},acc_sc: {acc_sc:.3f}, acc_sa: {acc_sa:.3f}, acc_wn: {acc_wn:.3f}, \
